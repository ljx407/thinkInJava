...
public class Ex10 {
	@Test
	public void test() {
		List<Rodent> rodents = RandomRodentGenerator.gen(10);
...
class RandomRodentGenerator {
	public static List<Rodent> gen(int n) {
